...
class APIHelper {
  ...
  Future<dynamic> verifyViaFirebase(String? phone, String? status, String? referralCode) async {
    try {
      ...
      debugPrint("({'user_phone': $phone, 'status': $status, 'referral_code': $referralCode, 'device_id': ${global.appDeviceId}})");
      debugPrint("formData.toString()formData.toString()formData.toString()formData.toString()");
      debugPrint('${global.baseUrl}verify_via_firebase');
