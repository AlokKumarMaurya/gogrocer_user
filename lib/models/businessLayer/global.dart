...
String baseUrl = 'https://hygienehalalfoods.com/new/api/';

//was running on the below url
// String baseUrl = 'https://hygienehalalfoods.com/backend/secure/';
int cartCount = 0;
