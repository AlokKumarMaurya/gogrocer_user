                    ...
                    children: [
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? Container(
                              ...
                              child: (_homeScreenData?.banner.isNotEmpty ?? false)
                                  ? CarouselSlider(
                                      items: _bannerItems(),
                                      carouselController: _carouselController,
                          ...
                          : _bannerShimmer(),
                      _isDataLoaded && _homeScreenData != null
                          ? (_homeScreenData?.banner.isNotEmpty ?? false)
                              ? Center(
                                  child: DotsIndicator(
                                    dotsCount: (_homeScreenData?.banner.isNotEmpty ?? false)
                                        ? _homeScreenData?.banner.length ?? 1
                                        : 1,
                      ...
                      Padding(
                        ...
                        child: _isDataLoaded && _homeScreenData != null && (_homeScreenData?.dealproduct.isNotEmpty ?? false)
                            ? Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? (_homeScreenData?.dealproduct.isNotEmpty ?? false)
                          ? BundleOffersMenu(
                      ...
                      _isDataLoaded &&
                              ...
                              (_homeScreenData?.catProdList.isNotEmpty ?? false)
                          ? ListView.builder(
                              shrinkWrap: true,
                      ...
                      Padding(
                        ...
                        child: _isDataLoaded &&
                                _homeScreenData != null &&
                                (_homeScreenData?.whatsnewProductList.isNotEmpty ?? false)
                            ? Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? Container(
                              ...
                              width: MediaQuery.of(context).size.width,
                              height: MediaQuery.of(context).size.height * 0.15,
                              child: (_homeScreenData?.secondBanner.isNotEmpty ?? false)
                                  ? CarouselSlider(
                          ...
                          : _bannerShimmer(),
                      _isDataLoaded && _homeScreenData != null
                          ? (_homeScreenData?.secondBanner.isNotEmpty ?? false)
                              ? Center(
                                  child: DotsIndicator(
                                    dotsCount:
                                        (_homeScreenData?.secondBanner.isNotEmpty ?? false)
                                            ? (_homeScreenData?.secondBanner.length ?? 1)
                                            : 1,
                                    position:
                      ...
                      Padding(
                        ...
                        child: _isDataLoaded &&
                                _homeScreenData != null &&
                                (_homeScreenData?.spotLightProductList.isNotEmpty ?? false)
                            ? Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                      ...
                      Padding(
                        ...
                        child: _isDataLoaded &&
                                _homeScreenData != null &&
                                (_homeScreenData?.recentSellingProductList.isNotEmpty ?? false)
                            ? Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                      ...
                      _isDataLoaded && _homeScreenData != null
                          ? (_homeScreenData?.topselling.isNotEmpty ?? false)
                              ? Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 16.0),
                                  child: ProductsMenu(
